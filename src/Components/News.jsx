...
export default class News extends Component {
  article = [
    {
      ...
      urlToImage:
        "https://onecms-res.cloudinary.com/image/upload/s--GerIVsYv--/fl_relative,g_south_east,l_one-cms:core:watermark:reuters,w_0.1/f_auto,q_auto/c_fill,g_auto,h_676,w_1200/v1/one-cms/core/2023-06-22t050413z_1_lynxmpej5l045_rtroptp_3_autos-electric-batteries.jpg?itok=kiv4AuQC",
    ...
    },
    {
      ...
      urlToImage:
        "https://media.zenfs.com/en/reuters-finance.com/c17dae0210b54c0abf67017b20e613fa",
      publishedAt: "2023-06-22T05:04:13Z",
      content:
    ...
    },
    {
      ...
      urlToImage:
        "https://img.zonebourse.com/reuters/2022-08/2022-08-09T180855Z_1_LYNXMPEI780V5_RTROPTP_3_FORD-MOTOR-PRICES.JPG",
    ...
    },
    {
      ...
      description:
        "Mark Zuckerberg is ready to take on Elon Musk. On Tuesday night (June 20), the 51-year-old Tesla CEO jokingly said that he’d be up for fighting Mark in a cage match. A day later, Mark responded with a post on Instagram. Keep reading to find out what he said… …",
  ...
  async componentDidMount() {
    let url =
      "https://newsapi.org/v2/top-headlines?country=us&apiKey=b4e92df4ad63422e820ec3184968894f&page=1";
  ...
  handleNextClick = async () => {
    ...
    if (this.state.page + 1 > Math.ceil(this.setState.totalResults / 20)) {
      ...
      let url = `https://newsapi.org/v2/top-headlines?country=us&apiKey=b4e92df4ad63422e820ec3184968894f&page=1${
        this.state.page + 1
      }&pageSize=20`;
      let data = await fetch(url);
      let parsedData = await data.json();
...
<button disabled={(this.state.page + 1 > Math.ceil(this.state.totalResults / 20))} className="btn btn-success" onClick={this.handleNextClick}>Next &rarr;</button>
